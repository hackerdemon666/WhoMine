...
public class ModBlocksRegistry {
    ...
    public static final Block SMALL_CHAIR = registerBlock("small_chair", new DyeableBlock(FabricBlockSettings.copyOf(Blocks.OAK_WOOD).strength(0.75f).nonOpaque(), ModBlockCollisionType.SMALL_CHAIR));
    public static final Block BIG_ARMCHAIR = registerBlock("big_armchair", new DyeableHorizontalFacingBlock(FabricBlockSettings.copyOf(Blocks.OAK_WOOD).strength(0.75f).nonOpaque(), ModBlockCollisionType.BIG_ARMCHAIR));
