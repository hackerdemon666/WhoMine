...
public class ModBlockTagsProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        getOrCreateTagBuilder(ModTagsRegistry.Blocks.CHAIR_BLOCKS)
                .add(ModBlocksRegistry.BAR_CHAIR)
                .add(ModBlocksRegistry.COOL_CHAIR)
                .add(ModBlocksRegistry.BIG_CHAIR)
                .add(ModBlocksRegistry.SMALL_CHAIR)
                .add(ModBlocksRegistry.BIG_ARMCHAIR)
                .add(ModBlocksRegistry.SMALL_ARMCHAIR);
