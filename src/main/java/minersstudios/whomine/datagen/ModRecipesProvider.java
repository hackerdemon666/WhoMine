...
//            ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItemsRegistry.FRAMED_PLANKS_ITEMS[i], 1)
//                    .pattern("WW")
//                    .input('W', getWoodItem("slab", i))
//                    .criterion(hasItem(getWoodItem("slab", i)), conditionsFromItem(getWoodItem("slab", i)))
//                    .offerTo(exporter, new Identifier(getRecipeName(ModItemsRegistry.FRAMED_PLANKS_ITEMS[i])));
            ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItemsRegistry.CARVED_PLANKS_ITEMS[i], 1)
                    .pattern("W")
                    .pattern("W")
                    .input('W', getWoodItem("slab", i))
                    .criterion(hasItem(getWoodItem("slab", i)), conditionsFromItem(getWoodItem("slab", i)))
                    .offerTo(exporter, new Identifier(getRecipeName(ModItemsRegistry.CARVED_PLANKS_ITEMS[i])));
        }
    }
